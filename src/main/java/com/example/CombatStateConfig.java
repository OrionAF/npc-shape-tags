...
public interface CombatStateConfig extends Config
{
    ...
    enum TrackedSkill { 
        ANY, ATTACK, STRENGTH, DEFENCE, RANGED, MAGIC, HITPOINTS, PRAYER, MINING, WOODCUTTING, FISHING, COOKING, THIEVING, SMITHING, FIREMAKING, FARMING, SLAYER, HUNTER, FLETCHING, CRAFTING, HERBLORE, AGILITY, RUNECRAFTING 
    }
    ...
    @ConfigItem(keyName = "hideInteractingObject", name = "Hide Interacted Object", description = "Hide the tag when you click/interact with an object", position = 25)
    default boolean hideInteractingObject() { return true; }
